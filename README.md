...
Σκοπός του έργου είναι η δημιουργία μιας αειφόρου και συμπεριλιπτικής πόλης που θα χρησιμοποιεί την Τεχνητη Νοησμοσύνη για να δημιουργεί καταλληλες συνθήκες διαβίωσης σε όλους τους πολίτες. Μιας πόλης που θα διαθέτει αντιπλημμυρικά έργα, έξυπνο φωτισμό, αυτόματες ταίστρες για ζώα, μετεορολογικό σταθμό και άλλες εφαρμογές ειδικές για άτομα με αναπηρία.  
